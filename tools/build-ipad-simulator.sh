...
# Gemfile.lock was generated by Bundler 1.17.2, which cannot run on current
# macOS runner Ruby. A current Bundler is lockfile-compatible and avoids that
# obsolete runtime failure without changing resolved application gems.
