#!/usr/bin/env python3
"""Download and verify every binary target declared by an ONLYOFFICE Editors package.
...
def main() -> int:
    ...
    parser.add_argument("--manifest", type=Path, required=True, help="Package.swift from the preserved public fork")
